...
export default function FavoritesList() {
  ...
  return (
    <>
      <section id="favStyling">
        <div>
          <h2 id="favPageTitle">Your Favorite Drinks</h2>
          <p id="content">
            Below are your favorite drinks. If you would like to favorite a new
            drink go to the bar.
          </p>
          <div>
            {favoritesList.map((favorite, index) => (
              <div key={index}>
                <a
                  target="_blank"
                  href={
                    "https://www.thecocktaildb.com/drink/" + favorite.idDrink
                  }
                  rel="noreferrer"
                >
